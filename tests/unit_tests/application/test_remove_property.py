...
def test_remove_property_success() -> None:
    ...
    use_case = RemovePropertyUseCase(database_repository=db_repo, page_repository=page_repo)
    out = use_case.execute(RemovePropertyUseCase.Input(database_name="DB", property_id="p1"))
